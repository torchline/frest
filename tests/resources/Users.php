...
class Users extends FRResource {
	public function setup() {		
		...
		$this->modifyReadSettings(array(
			...
			FRSetting::readResources('inbox', 'Messages', array('fields' => 'id,text,sender(id,name,rank(name))', 'receiver' => $this->value('id'))),
			FRSetting::readResources('outbox', 'Messages', array('fields' => 'id,text,receiver(id,name)', 'sender' => $this->value('id')))
		));
	}
}