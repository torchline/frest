...
require_once(dirname(__FILE__) . '/../Setting/Table.php');
require_once(dirname(__FILE__) . '/../Setting/Field.php');

require_once(dirname(__FILE__) . '/../Setting/FieldRead.php');
require_once(dirname(__FILE__) . '/../Setting/SingularResourceRead.php');
require_once(dirname(__FILE__) . '/../Setting/PluralResourceRead.php');
require_once(dirname(__FILE__) . '/../Setting/ComputedRead.php');

require_once(dirname(__FILE__) . '/../Setting/Condition.php');
require_once(dirname(__FILE__) . '/../Setting/Order.php');
require_once(dirname(__FILE__) . '/../Setting/Create.php');
require_once(dirname(__FILE__) . '/../Setting/Update.php');
...
class Settings {
	 ...
	 * @return Field
	 */
	static function field($alias, $field, $variableType = Enum\VariableType::STRING) {
