...
final class VariableType {
	...
	public static function arrayVariableTypeFromElement($variableType) {
		switch ($variableType) {
			case self::BOOL:
				return VariableType::ARRAY_BOOL;
				break;
			case self::INT:
				return VariableType::ARRAY_INT;
				break;
			case self::FLOAT:
				return VariableType::ARRAY_FLOAT;
				break;
			case self::STRING:
	...
	public static function stricterVariableType($variableType1, $variableType2) {
		...
		switch ($variableType1) {
			case VariableType::ARRAY_BOOL:
			case VariableType::ARRAY_INT:
			case VariableType::ARRAY_FLOAT:
			case VariableType::ARRAY_STRING:
				$isVar1Array = TRUE;
				$var1ElementVariableType = VariableType::arrayElementVariableType($variableType1);
				break;
		}
		...
		switch ($variableType2) {
			...
			case VariableType::ARRAY_STRING:
				$isVar2Array = TRUE;
				$var2ElementVariableType = VariableType::arrayElementVariableType($variableType2);
				break;
		}
		...
		if ($isVar1Array == $isVar2Array) {
			...
			$stricterElementType = VariableType::stricterVariableType($var1ElementVariableType, $variableType2);
			return VariableType::arrayVariableTypeFromElement($stricterElementType);
		}
		else {
			$stricterElementType = VariableType::stricterVariableType($variableType1, $var2ElementVariableType);
			return VariableType::arrayVariableTypeFromElement($stricterElementType);
		}
	}
	...
	public static function castValue($value, $variableType) {
		switch ($variableType) {
			...
			case VariableType::ARRAY_STRING:
				...
				$elementType = VariableType::arrayElementVariableType($variableType);
				...
				foreach ($valueArray as $i=>$arrayValue) {
					...
					$newArrayValue = VariableType::castValue($arrayValue, $elementType);
