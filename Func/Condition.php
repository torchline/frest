...
require_once(dirname(__FILE__) . '/FunctionParam.php');
...
class Condition {
	...
	public static function GreaterThanFunction() {
		return new Condition(
			...
			'>',
			array(
				new FunctionParam(Enum\VariableType::FLOAT)
			)
		);
	}
	...
	public static function InFunction() {
		return new Condition(
			...
			'IN',
			array(
				new FunctionParam(Enum\VariableType::ARRAY_STRING)
			)
		);
	}
	...
	public static function LikeFunction() {
		return new Condition(
			...
			'LIKE',
			array(
				new FunctionParam(Enum\VariableType::STRING)
			),
			array(
				'~' => '%'
			)
	...
	public function validateValue($valueString) {
		...
		foreach ($values as $i=>$value) {
			...
			$castedValue = Enum\VariableType::castValue($value, $parameter->getVariableType());
